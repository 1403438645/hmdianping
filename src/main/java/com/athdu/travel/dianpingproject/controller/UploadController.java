...
//            返回结果
    ...
    public Result deleteBlogImage(@RequestParam("name") String filename){
...
//        生成目录
        ...
        int d2 = (hash >> 4) & 0xF;
//        判断目录是否存在
        File file = new File(SystemConstants.IMAGE_UPLOAD_DIR, StrUtil.format("/blog/{}/{}", d1, d2));
        if (!file.exists()){
            file.mkdirs();
        }

//        生成文件名
        return StrUtil.format("blog/{}/{}/{}.{}",d1,d2,name,suffix);
    }
}
